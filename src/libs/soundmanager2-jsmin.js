...
(function (h, g) {
  function J(sb, J) {
    ...
    var V, c = this, Ya = null, l = null, E, v = navigator.userAgent,
        ia = h.location.href.toString(), m = document, xa, Za, ya, n, H = [],
        za = !0, C, W = !1, X = !1, q = !1, y = !1, ja = !1, p, tb = 0, Y, A,
        Aa, Q, Ba, O, R, S, $a, Ca, Da, ka, z, la, P, Ea, Z, ma, na, T, ab, Fa,
        bb = ["log", "info", "warn", "error"], Ga, Ha, cb, aa = null, Ia = null,
        t, Ja, U, db, oa, pa, K, w, ba = !1, Ka = !1, eb, fb, gb, qa = 0,
        ca = null, ra, L = [], da, u = null, hb, sa, ea, ib, M, ta, La, jb, x,
        kb = Array.prototype.slice, B = !1, Ma, G,
        Na, lb, I, mb, Oa, fa, nb = 0, Pa, Qa = v.match(/(ipad|iphone|ipod)/i),
        Ra = v.match(/android/i), N = v.match(/msie|trident/i),
        ub = v.match(/webkit/i), ua = v.match(/safari/i) && !v.match(/chrome/i),
        Sa = v.match(/opera/i),
        ...
        wa = ua && (m.hasFocus === g || !m.hasFocus()), ob = !wa,
        pb = /(mp3|mp4|mpa|m4a|m4b)/i, ga =
    ...
    var Wa;
    try {
      Wa = Audio !== g && (Sa && opera !== g && 10 > opera.version() ?
          new Audio(null) : new Audio).canPlayType !== g
    }
    catch (xb) {
      Wa = !1
    }
    ...
    this.setup = function (b) {
      ...
      if (!B) {
        if (va) {
          if (!c.setupOptions.ignoreMobileRestrictions || c.setupOptions.forceUseGlobalHTML5Audio) {
            L.push(z.globalHTML5), B = !0
          }
        }
        else {
          c.setupOptions.forceUseGlobalHTML5Audio && (L.push(z.globalHTML5), B = !0);
        }
      }
      if (!Pa && va) {
        if (c.setupOptions.ignoreMobileRestrictions) {
          L.push(z.ignoreMobile);
        }
        else if (c.setupOptions.useHTML5Audio &&
        !c.setupOptions.preferFlash || c._wD(z.mobileUA), c.setupOptions.useHTML5Audio = !0, c.setupOptions.preferFlash = !1, Qa) {
          c.ignoreFlash = !0;
        }
        else if (Ra && !v.match(/android\s2\.3/i) || !Ra) {
          c._wD(z.globalHTML5), B = !0;
        }
      }
    ...
    this.createSound = function (b, d) {
      ...
      if (sa(f)) {
        a = e(), c.html5Only || c._wD(f.id + ": Using HTML5"), a._setup_html5(f);
      }
      else {
        if (c.html5Only) {
        ...
        if (c.html5.usingFlash && f.url && f.url.match(/data:/i)) {
          return c._wD(f.id + ": data: URIs not supported via Flash. Exiting."), e();
        }
    ...
    this.start = this.play =
        function (b, d) {
          ...
          if (!q || !c.ok()) {
            return K("soundManager.play(): " + t(q ? "notOK" : "notReady")), !1;
          }
          if (w(b, a)) {
            a && (d = {url: d});
          }
    ...
    this.toggleMute = function (b) {
      return w(b) ? c.sounds[b].toggleMute() :
          !1
    };
    ...
    this.canPlayURL = function (b) {
      ...
      !d && u && (d = b &&
      c.ok() ? !!b.match(c.filePattern) : null);
      return d
    };
    ...
    this.onready = function (b, d) {
      if ("function" === typeof b) {
        q && c._wD(t("queue", "onready")), d || (d = h), Ba("onready", b, d), O();
      }
      else {
    ...
    this.ontimeout = function (b, d) {
      if ("function" ===
          typeof b) {
        q && c._wD(t("queue", "ontimeout")), d || (d = h), Ba("ontimeout", b, d), O({type: "ontimeout"});
      }
      else {
    ...
    V = function (b) {
      var d, e, a = this, f, h, k, F, m, q, r = !1, D = [], v = 0, Xa, y,
          u = null, z;
      e = d = null;
      ...
      this.load = function (b) {
        ...
        if (!e.url && !a.url) {
          return c._wD(a.id + ": load(): url is unassigned. Exiting.", 2), a;
        }
        a.isHTML5 || 8 !== n ||
        a.url || e.autoPlay || c._wD(a.id + ": Flash 8 load() limitation: Wait for onload() before calling play().", 1);
        if (e.url === a.url && 0 !== a.readyState && 2 !== a.readyState) {
          return p("onURL", 1), 3 === a.readyState && e.onload && fa(a, function () {
        ...
        a.id3 = {};
        if (sa(e)) {
          d = a._setup_html5(e), d._called_load ? c._wD(a.id + ": Ignoring request to load again") : (a._html5_canplay = !1, a.url !== e.url && (c._wD(p("manURL") + ": " + e.url), a._a.src = e.url, a.setPosition(0)), a._a.autobuffer =
              "auto", a._a.preload = "auto", a._a._called_load = !0);
        }
        else {
          if (c.html5Only) {
          ...
          try {
            a.isHTML5 = !1, a._iO = pa(oa(e)), a._iO.autoPlay && (a._iO.position || a._iO.from) && (c._wD(a.id + ": Disabling autoPlay because of non-zero offset case"), a._iO.autoPlay = !1), e = a._iO, 8 === n ? l._load(a.id, e.url, e.stream, e.autoPlay, e.usePolicyFile) : l._load(a.id, e.url, !!e.stream, !!e.autoPlay,
                e.loops || 1, !!e.autoLoad, e.usePolicyFile)
          }
          catch (f) {
      ...
      this.start = this.play = function (b, d) {
        ...
        if (!a.isHTML5 && a._iO.serverURL && !a.connected) {
          return a.getAutoPlay() || (c._wD(e + " Netstream not connected yet - setting autoPlay"), a.setAutoPlay(!0)), a;
        }
        sa(a._iO) && (a._setup_html5(a._iO), m());
        if (1 === a.playState && !a.paused) {
          f = a._iO.multiShot;
          if (!f) {
            return c._wD(e + "Already playing (one-shot)",
                1), a.isHTML5 && a.setPosition(a._iO.position), a;
          }
        ...
        if (a.loaded) {
          ...
          if (a.isHTML5 || c.html5Only) {
            if (a.isHTML5) {
              ...
              return c._wD(e + "Unsupported type. Exiting."), a;
            }
          }
          else {
          ...
          if (2 === a.readyState) {
            return c._wD(e + "Could not load - exiting",
                2), a;
          }
        ...
        a.paused && 0 <= a.position && (!a._iO.serverURL || 0 < a.position) ? (c._wD(e + "Resuming from paused state", 1), a.resume()) : (a._iO = A(b, a._iO), (!a.isHTML5 && null !== a._iO.position && 0 < a._iO.position || null !== a._iO.from && 0 < a._iO.from || null !== a._iO.to) && 0 === a.instanceCount && 0 === a.playState && !a._iO.serverURL && (f = function () {
          a._iO = A(b, a._iO);
          a.play(a._iO)
        },
      ...
      this.setAutoPlay = function (b) {
        ...
        a._iO.autoPlay = b;
        a.isHTML5 || (l._setAutoPlay(a.id, b), b &&
        !a.instanceCount && 1 === a.readyState && (a.instanceCount++, c._wD(a.id + ": Incremented instance count to " + a.instanceCount)))
      };
      ...
      this.setPosition = function (b) {
        ...
        a._iO.position = d;
        if (!a.isHTML5) {
          b = 9 === n ? a.position : b, a.readyState && 2 !== a.readyState && l._setPosition(a.id, b, a.paused || !a.playState, a._iO.multiShot);
        }
        else if (a._a) {
          if (a._html5_canplay) {
            if (a._a.currentTime.toFixed(3) !== b.toFixed(3)) {
              ...
              try {
                ...
                c._wD(a.id + ": setPosition(" + b + ") failed: " +
                    e.message, 2)
              }
            }
          }
          else if (b) {
            return c._wD(a.id + ": setPosition(" + b + "): Cannot seek yet, sound not ready", 2), a;
          }
      ...
      this.resume = function () {
        ...
        a.playState = 1;
        a.isHTML5 ?
            (a._setup_html5().play(), m()) : (b.isMovieStar && !b.serverURL && a.setPosition(a.position), l._pause(a.id, b.multiShot));
      ...
      this.togglePause = function () {
        ...
        if (0 === a.playState) {
          return a.play({position: 9 !== n || a.isHTML5 ? a.position / 1E3 : a.position}), a;
        }
      ...
      this.unmute = function () {
        ...
        a.isHTML5 ? a._a && (a._a.muted = !1) : l._setVolume(a.id, b ? a._iO.volume :
            a.options.volume);
        return a
      };
      ...
      this._processOnPosition = function () {
        var b, c;
        b = D.length;
        if (!b || !a.playState || v >= b) {
          return !1;
        }
        for (--b; 0 <= b; b--) {
          c = D[b], !c.fired &&
          a.position >= c.position && (c.fired = !0, v++, c.method.apply(c.scope, [c.position]));
        }
        return !0
      };
      ...
      y = function () {
        ...
        null === d || isNaN(d) || (b.position = d, b.multiShot =
            !1, f());
        return b
      };
      q = function () {
      ...
      this._onTimer = function (b) {
        var c, f = !1, g = {};
        (a._hasTimer || b) && a._a && (b || (0 < a.playState || 1 === a.readyState) && !a.paused) && (c = a._get_html5_duration(), c !== d && (d = c, a.duration = c, f = !0), a.durationEstimate = a.duration, c = 1E3 * a._a.currentTime ||
            0, c !== e && (e = c, f = !0), (f || b) && a._whileplaying(c, g, g, g, g));
        return f
      };
      ...
      this._setup_html5 = function (b) {
        b = A(a._iO, b);
        var c = B ? Ya : a._a, d = decodeURI(b.url), e;
        B ? d === decodeURI(Ma) && (e = !0) : d === decodeURI(u) && (e = !0);
        if (c) {
          if (c._s) {
            if (B) {
              c._s &&
              c._s.playState && !e && c._s.stop();
            }
            else if (!B && d === decodeURI(u)) {
          ...
          b.autoLoad || b.autoPlay ? (a._a = new Audio(b.url), a._a.load()) : a._a = Sa && 10 > opera.version() ? new Audio(null) : new Audio, c = a._a, c._called_load = !1, B && (Ya = c);
        }
        a.isHTML5 = !0;
        a._a = c;
        c._s = a;
      ...
      this._onload = function (b) {
        ...
        d || a.isHTML5 || (!0 === c.sandbox.noRemote && c._wD(b + t("noNet"),
            1), !0 === c.sandbox.noLocal && c._wD(b + t("noLocal"), 1));
        a.loaded = d;
        a.readyState = d ? 3 : 2;
        a._onbufferchange(0);
      ...
      this._onfinish = function () {
        ...
        a.instanceCount || (Xa(), a.playState = 0, a.paused = !1, a.instanceCount = 0, a.instanceOptions = {}, a._iO = {}, F(), a.isHTML5 && (a.position = 0)), a.instanceCount && !a._iO.multiShotEvents || !b || (c._wD(a.id + ": onfinish()"), fa(a, function () {
          b.apply(a)
        })))
      };
      this._whileloading = function (b, c, d, e) {
        ...
        a.bufferLength = e;
        a.durationEstimate = a.isHTML5 || f.isMovieStar ? a.duration : f.duration ? a.duration > f.duration ? a.duration : f.duration : parseInt(a.bytesTotal / a.bytesLoaded *
            a.duration, 10);
      ...
      this._whileplaying = function (b, c, d, e, f) {
        ...
        !a.isHTML5 && 8 < n && (k.usePeakData && c !== g && c && (a.peakData = {
          ...
          right: e.split(",")
            ...
            a.eqData = b, a.eqData.left = b, f.rightEQ !== g && f.rightEQ && (a.eqData.right = f.rightEQ.split(","))));
      ...
      this._onconnect = function (b) {
        ...
        if (a.connected = b) {
          a.failures = 0, w(a.id) && (a.getAutoPlay() ? a.play(g, a.getAutoPlay()) : a._iO.autoLoad && a.load()), a._iO.onconnect && a._iO.onconnect.apply(a, [b])
        }
      };
      this._ondataerror =
          function (b) {
    ...
    A = function (b, d) {
      ...
      for (f in a) {
        a.hasOwnProperty(f) && e[f] === g && (e[f] = "object" !== typeof a[f] || null === a[f] ? a[f] : A(e[f], a[f]));
      }
      return e
    };
    fa = function (b, c) {
    ...
    Q = {
      onready: 1, ontimeout: 1, defaultOptions: 1, flash9Options: 1,
      movieStarOptions: 1
    };
    Aa = function (b, d) {
      ...
      for (e in b) {
        if (b.hasOwnProperty(e)) {
          if ("object" !== typeof b[e] || null === b[e] || b[e] instanceof Array || b[e] instanceof RegExp) {
            f && Q[d] !== g ? c[d][e] = b[e] : h[e] !== g ? (c.setupOptions[e] = b[e], c[e] = b[e]) : Q[e] ===
            g ? (K(t(c[e] === g ? "setupUndef" : "setupError", e), 2), a = !1) : c[e] instanceof Function ? c[e].apply(c, b[e] instanceof Array ? b[e] : [b[e]]) : c[e] = b[e];
          }
          else if (Q[e] === g) {
            K(t(c[e] === g ? "setupUndef" : "setupError", e), 2), a = !1;
          }
          else {
            return Aa(b[e], e);
          }
    ...
    x = function () {
      ...
      var e = h.attachEvent, a = {
        add: e ? "attachEvent" : "addEventListener", remove: e ?
    ...
    I = {
        ...
        if (!b._html5_canplay) {
          ...
          if (this.currentTime !== d) {
            ...
            try {
              ...
              c._wD(b.id + ": canplay: Setting position of " +
                  d + " failed: " + e.message, 2)
            }
          }
      ...
      playing: r(function () {
        ...
        var d = this._s, e, a, f;
        e = 0;
        var g = "progress" === b.type, k = b.target.buffered, h = b.loaded || 0,
            m = b.total || 1;
        d.buffered = [];
        if (k && k.length) {
          e = 0;
          ...
          if (g && 1 < k.length) {
            ...
            a = k.length;
            for (e = 0; e < a; e++) {
              f.push(1E3 * b.target.buffered.start(e) + "-" +
                  1E3 * b.target.buffered.end(e));
            }
    ...
    ea = function (b) {
      ...
      a && c.html5[a] !== g ? d = c.html5[a] && !ha(a) : (b = "audio/" + a, d = c.html5.canPlayType({type: b}),
    ...
    jb = function () {
        ...
        if (a instanceof Array) {
          ...
          for (b = a.length; k < b; k++) {
            if (c.html5[a[k]] || d.canPlayType(a[k]).match(c.html5Test)) {
              e = !0, c.html5[a[k]] = !0, c.flash[a[k]] = !!a[k].match(pb);
            }
          }
          b = e
        }
        else {
          a = d && "function" === typeof d.canPlayType ? d.canPlayType(a) : !1, b = !(!a || !a.match(c.html5Test));
        }
        return b
      }
      ...
      var d = Audio !== g ? Sa && 10 > opera.version() ?
          new Audio(null) : new Audio : null, e, a, f = {}, h, k;
      h = c.audioFormats;
      for (e in h) {
    ...
    K = function (b) {
      Ua && console.warn !== g ? console.warn(b) :
          c._wD(b)
    };
    xa = function () {
      return !1
    ...
    Da = function () {
      ...
      8 < n ? (c.defaultOptions = A(c.defaultOptions, c.flash9Options), c.features.buffering = !0, c.defaultOptions = A(c.defaultOptions, c.movieStarOptions), c.filePatterns.flash9 = new RegExp("\\.(mp3|" +
          rb.join("|") + ")(\\?.*)?$", "i"), c.features.movieStar = !0) : c.features.movieStar = !1;
    ...
    db = function () {
      var b = E(c.debugID), d = E(c.debugID + "-toggle");
    ...
    Ja = function () {
      var b = t("fbHandler"), d = c.getMoviePercent(), e = {type: "FLASHBLOCK"};
      c.html5Only || (c.ok() ? (c.didFlashBlock && c._wD(b + ": Unblocked"), c.oMC && (c.oMC.className = [U(), "movieContainer", "swf_loaded" + (c.didFlashBlock ? " swf_unblocked" : "")].join(" "))) : (u && (c.oMC.className = U() + " movieContainer " + (null === d ? "swf_timedout" : "swf_error"), c._wD(b + ": " + t("fbTimeout") +
          (d ? " (" + t("fbLoaded") + ")" : ""))), c.didFlashBlock = !0, O({
        type: "ontimeout",
        ignoreInit: !0,
        error: e
      }), T(e)))
    ...
    O = function (b) {
      ...
      if (!q && b && !b.ignoreInit || "ontimeout" === b.type && (c.ok() || y && !b.ignoreInit)) {
        return !1;
      }
      var d = {success: b && b.ignoreInit ? c.ok() : !y},
          e = b && b.type ? H[b.type] || [] : [], a = [], f, d = [d],
          g = u && !c.ok();
    ...
    Na = function () {
      ...
      var b = !1, c = navigator, e, a = h.ActiveXObject, f;
      try {
        f = c.plugins
      }
      catch (m) {
      ...
      if (f && f.length) {
        (c = c.mimeTypes) && c["application/x-shockwave-flash"] &&
        c["application/x-shockwave-flash"].enabledPlugin && c["application/x-shockwave-flash"].enabledPlugin.description && (b = !0);
      }
    ...
    hb = function () {
      ...
      Qa && v.match(/os (1|2|3_0|3_1)\s/i) ? (c.hasHTML5 = !1, c.html5Only = !0, c.oMC && (c.oMC.style.display = "none")) : c.useHTML5Audio && (c.html5 && c.html5.canPlayType || (c._wD("SoundManager: No HTML5 Audio() support detected."), c.hasHTML5 = !1), Ta &&
      c._wD("soundManager: Note: Buggy HTML5 Audio in Safari on this OS X release, see https://bugs.webkit.org/show_bug.cgi?id=32159 - " + (G ? "will use flash fallback for MP3/MP4, if available" : " would use flash fallback for MP3/MP4, but none detected."), 1));
      if (c.useHTML5Audio && c.hasHTML5) {
        for (d in da = !0, e) {
      ...
      c.html5Only = c.hasHTML5 && c.useHTML5Audio &&
          !b;
      return !c.html5Only
    };
    ra = function (b) {
    ...
    lb = function () {
      if (Ta && Na()) {
        ...
        for (e in b) {
          if (b.hasOwnProperty(e) && ("mp3" === e || "mp4" === e) && (c._wD("soundManager: Using flash fallback for " + e + " format"), c.html5[e] =
              !1, b[e] && b[e].related)) {
    ...
    this._externalInterfaceOK = function (b) {
      if (!c.swfLoaded) {
        ...
        Ta && lb();
        b &&
        b.replace(/\+dev/i, "") === c.versionNumber.replace(/\+dev/i, "") ? setTimeout(ya, N ? 100 : 1) : (d = 'soundManager: Fatal: JavaScript file build "' + c.versionNumber + '" does not match Flash SWF build "' + b + '" at ' + c.url + ". Ensure both are up-to-date.", setTimeout(function () {
          throw Error(d);
        }, 0))
      }
    };
    na = function (b, d) {
      ...
      if (c.html5Only) {
        return Da(), e(), c.oMC = E(c.movieID), ya(), X = W = !0, !1;
      }
      var f = d || c.url, h = c.altURL || f, k = ma(), l = U(), n = null,
          n = m.getElementsByTagName("html")[0], p, r, q,
      ...
      if (N) {
        f = m.createElement("div"), r = ['<object id="' + b + '" data="' + d + '" type="' + k.type + '" title="' + k.title + '" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,40,0">',
          a("movie", d), a("AllowScriptAccess", c.allowScriptAccess), a("quality", k.quality), c.wmode ? a("wmode", c.wmode) : "", a("bgcolor", c.bgColor), a("hasPriority", "true"), c.debugFlash ? a("FlashVars", k.FlashVars) : "", "</object>"].join("");
      }
      else {
        for (p in f = m.createElement("embed"), k) {
      ...
      l = U();
      if (k = ma()) {
        if (c.oMC = E(c.movieID) || m.createElement("div"), c.oMC.id) {
          q = c.oMC.className, c.oMC.className = (q ? q + " " : "movieContainer") + (l ? " " + l : ""), c.oMC.appendChild(f), N && (p = c.oMC.appendChild(m.createElement("div")),
              p.className = "sm2-object-box", p.innerHTML = r), X = !0;
        }
        else {
          c.oMC.id = c.movieID;
          ...
          try {
            N || c.oMC.appendChild(f),
                k.appendChild(c.oMC), N && (p = c.oMC.appendChild(m.createElement("div")), p.className = "sm2-object-box", p.innerHTML = r), X = !0
          }
          catch (u) {
            throw Error(t("domError") + " \n" + u.toString());
          }
    ...
    $a = function () {
      ...
      c.url && !ba && (ba = !0, x.remove(h, "load", S), G && wa && !Va ? p("waitFocus") : (q || (b = c.getMoviePercent(), 0 < b && 100 > b && (d = !0)), setTimeout(function () {
        b = c.getMoviePercent();
        d ? (ba = !1, c._wD(t("waitSWF")), h.setTimeout(S, 1)) : (q || (c._wD("soundManager: No Flash response within expected time. Likely causes: " +
    ...
    mb = function () {
      ...
      if (c.useHTML5Audio && c.hasHTML5) {
        for (b in c.audioFormats) {
          c.audioFormats.hasOwnProperty(b) && d.push(b + " = " + c.html5[b] + (!c.html5[b] && u && c.flash[b] ? " (using flash)" : c.preferFlash &&
          c.flash[b] && u ? " (preferring flash)" : c.html5[b] ? "" : " (" + (c.audioFormats[b].required ? "required, " : "") + "and no flash support)"));
        }
    ...
    Y = function (b) {
      ...
      if (c.html5Only) {
        return p("sm2Loaded", 1), q = !0, R(), C("onload", !0), !0;
      }
      var d = !0, e;
      c.useFlashBlock && c.flashLoadTimeout && !c.getMoviePercent() || (q = !0);
      e = {type: !G && u ? "NO_FLASH" : "INIT_TIMEOUT"};
      c._wD("SoundManager 2 " + (y ? "failed to load" : "loaded") + " (" + (y ? "Flash security/load error" : "OK") + ") " + String.fromCharCode(y ?
          10006 : 10003), y ? 2 : 1);
    ...
    ya = function () {
      ...
      if (c.html5Only) {
        return q || (x.remove(h, "load", c.beginDelayedInit), c.enabled = !0, Y()), !0;
      }
      la();
      try {
    ...
    x.add(h,
        "load", S);
    x.add(h, "load", Ea);
    m.addEventListener ? m.addEventListener("DOMContentLoaded", P, !1) : m.attachEvent ? m.attachEvent("onreadystatechange", La) : (C("onload", !1), T({
      type: "NO_DOM2_EVENTS",
      fatal: !0
    }))
  }
  ...
  "object" === typeof module && module && "object" === typeof module.exports ? (module.exports.SoundManager = J, module.exports.soundManager = V) : "function" === typeof define &&
      define.amd && define(function () {
        return {
          constructor: J, getInstance: function (g) {
